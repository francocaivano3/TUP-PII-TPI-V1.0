...
partida1.ingresarJugadores(jugador1)
partida1.ingresarJugadores(jugador2)
partida1.ingresarJugadores(jugador3)
print(partida1.listaJugadores)
#Pregunta 1
pregunta1 = Tarjeta("¿Cuál es el país más grande del mundo en territorio?", Categoria("Azul", "Geografía", 2))
...
print(partida1.mazo[0])
#Pregunta 2
pregunta2 = Tarjeta("¿Cuántas provincias tiene Argentina?", Categoria("Azul", "Geografía", 2))
...
partida1.mazo.append(pregunta2)
print(partida1.mazo[1])
#Pregunta 3
